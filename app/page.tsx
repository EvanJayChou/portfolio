    ...
    <div className="flex min-h-screen flex-col pt-16 relative overflow-hidden">
      ...
      <div className="relative flex flex-grow flex-col md:flex-row z-10">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-x-0 bottom-0 flex h-[70vh] flex-col items-center justify-center px-6 pt-20 text-center md:inset-x-auto md:right-0 md:top-0 md:h-full md:w-[65%] md:items-end md:justify-center md:pr-16 md:pt-0 md:text-right">
